...
var ASPECT, FAR, FOV, HEIGHT, NEAR, P, T, TAU, V3, WIDTH, a, addBumper, animate, ball, ball_hit_ball, ball_hit_fuzz, balls, bch, bcw, bumper_material, camera, canvas, colors, controls, ctx, cue_hit_ball, dir, foo, gch, gcw, ground, ground_canvas, ground_ctx, ground_material, ground_tex, i, id, light, map, materialArray, mouse, ptl, ptw, rand, randy, renderer, scene, skyBox, skyBoxGeometry, skyBoxMaterial, unprojector, white;
...
materialArray = (function() {
  ...
  _ref = ["xpos", "xneg", "ypos", "yneg", "zpos", "zneg"];
  _results = [];
  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    dir = _ref[_i];
    _results.push(new T.MeshBasicMaterial({
