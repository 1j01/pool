...
var ASPECT, FAR, FOV, HEIGHT, NEAR, P, T, TAU, V3, WIDTH, a, addBumper, animate, ball, balls, bch, bcw, bumper_material, camera, canvas, colors, controls, ctx, gch, gcw, ground, ground_canvas, ground_ctx, ground_material, ground_tex, i, id, light, map, ptl, ptw, rand, randy, renderer, scene, skyBox, skyBoxGeometry, skyBoxMaterial, white;
...
addBumper = function() {
  var bumper;
  bumper = new P.BoxMesh(new T.BoxGeometry(ptl, 20, ptw, 5, 5, 5), bumper_material, 0);
