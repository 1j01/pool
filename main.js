...
var ASPECT, FAR, H, HEIGHT, L, NEAR, P, T, TAU, V3, VIEW_ANGLE, W, WIDTH, a, addBumper, animate, ball, balls, bumper_material, camera, canvas, colors, controls, ctx, ground, ground_material, i, light, map, rand, randy, renderer, scene, skyBox, skyBoxGeometry, skyBoxMaterial, white;
...
ground = new P.BoxMesh(new T.BoxGeometry(L, 50, W), ground_material, 0);
...
addBumper = function() {
  var bumper;
  bumper = new P.BoxMesh(new T.BoxGeometry(L, 20, W), bumper_material, 0);
